...
const LogisticsFilterModal = ({ isOpen, onClose, onApply }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[23rem] md:max-w-sm h-full lg:max-w-md px-4 lg:px-6  rounded-none lg:rounded-lg dark:bg-war dark:border-edgar/20">
        <DialogHeader>
        ...
        <div className="grid gap-1 lg:gap-3 max-h-[495px] overflow-auto lg:overflow-visible p-2">
          <div className="flex flex-col lg:flex-row whitespace-nowrap items-start lg:items-center justify-between max-w-full w-full ">
            ...
            <input
              ...
              className="max-w-[17rem] w-full px-4 py-2 border border-quatanery rounded-md focus:outline-none focus:ring-2 focus:ring-commodore  dark:bg-commodore  dark:border-whitefade/20 dark:focus:ring-white/20"
            />
          </div>
          {/* PO Date */}
            ...
            <div className="flex flex-col gap-2 max-w-[17rem] w-full">
              <Popover open={isStartOpen} onOpenChange={setIsStartOpen}>
                <PopoverTrigger asChild>
                  <button
                    variant="outline"
                    className="flex w-full px-4 py-2 border text-sm lg:text-base items-center gap-1 border-quatanery rounded-md focus:outline-none focus:ring-2 focus:ring-commodore  dark:bg-commodore  dark:border-whitefade/20 dark:focus:ring-white/20"
            ...
            <div className="flex flex-col lg:flex-row whitespace-nowrap items-start lg:items-center justify-between max-w-full w-full ">
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  placeholder="9"
                  min="0"
                  className="appearance-none max-w-[13rem] w-full text-center px-4 py-2 border border-quatanery rounded-md focus:outline-none focus:ring-2 focus:ring-commodore  dark:bg-commodore  dark:border-whitefade/20 dark:focus:ring-white/20 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                />
              </div>
            </div>
            <div className="grid grid-cols-1 gap-2">
...
export default LogisticsFilterModal;
