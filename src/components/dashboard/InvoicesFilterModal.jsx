...
const InvoicesFilterModal = ({ isOpen, onClose, onApply }) => {
      ...
      <DialogContent className="max-w-[23rem] md:max-w-sm lg:max-w-md h-full px-4 lg:px-6 rounded-none lg:rounded-lg dark:bg-war dark:border-edgar/20">
        ...
        <div className="grid gap-1 lg:gap-3 max-h-[495px] overflow-auto lg:overflow-visible p-2">
          ...
          <div className="flex flex-col lg:flex-row whitespace-nowrap items-start justify-between max-w-full w-full ">
            ...
            <div className="flex flex-col gap-2 max-w-full lg:max-w-[17rem] w-full">
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={(selectedDate) => {
                      ...
                      setIsStartOpen(false); // Close popover
                    }}
                  />
                </PopoverContent>
              </Popover>
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={(selectedDate) => {
                      ...
                      setIsEndOpen(false); // Close popover
                    }}
                  />
                </PopoverContent>
              </Popover>
          ...
          <div className="flex flex-col lg:flex-row whitespace-nowrap items-start lg:items-center justify-between max-w-full w-full ">
            ...
            <input
              ...
              min="0"
              max="100"
              className="appearance-none max-w-full lg:max-w-[17rem] w-full px-4 py-2 border border-quatanery rounded-md focus:outline-none focus:ring-2 focus:ring-commodore  dark:bg-commodore  dark:border-whitefade/20 dark:focus:ring-white/20 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
            />
          </div>
              ...
              <div className="flex flex-col lg:flex-row whitespace-nowrap items-start lg:items-center justify-between max-w-full w-full ">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder=">="
                    min="0"
                    className="max-w-[3.5rem] w-full text-center px-2 py-2 border border-quatanery rounded-md focus:outline-none focus:ring-2 focus:ring-commodore  dark:bg-commodore  dark:border-whitefade/20 dark:focus:ring-white/20 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                  />
                  <input
                    type="number"
                    name="maxReceived"
                    ...
                    placeholder="0"
                    min="0"
                    className="max-w-full lg:max-w-[13rem] w-full text-center px-4 py-2 border border-quatanery rounded-md focus:outline-none focus:ring-2 focus:ring-commodore  dark:bg-commodore  dark:border-whitefade/20 dark:focus:ring-white/20 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                  />
                </div>
              </div>
            </div>
          ...
          {/* Delivered Switch */}
          <div className="grid grid-cols-1 gap-2">
            <div className="flex flex-col lg:flex-row whitespace-nowrap items-start lg:items-center gap-2 lg:gap-[70px] max-w-full w-full ">
              <label htmlFor="number" className="text-sm lg:text-base">
                Paid:
              </label>
